...
For the heatmap, I ended up processing every 20 frames with a thresold of 5. I experimented with different values and none were really great. This one lowered the number of false positives, although it does lead to a bit of jitter in the video...
